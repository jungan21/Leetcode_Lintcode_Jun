...
public class BinaryTreePathSumII {
	...
	public static void dfs(TreeNode root, int target, List<Integer> list,
		...
		list.add(root.val);
		/**
		 * level from 0 to heith of the tree
		 * 
		 * level越来越深时， 从下往上找，譬如main方法里的树， 当，lelve到节点node 4时， List 里面[1, 2, 4],
		 * target 6 减4， 再减2，等于零
		 * 
		 */
		...
		// level +1, target不变，和 BinaryTreePathSum 的区别，英文，每一层，每一个点都有可能是起点
