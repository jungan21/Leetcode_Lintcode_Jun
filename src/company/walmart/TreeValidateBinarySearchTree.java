...
public class TreeValidateBinarySearchTree {
	...
	public static void main(String[] args) {
		...
		tree_divideConquer.TreeNode right = new tree_divideConquer.TreeNode(2);

		tree_divideConquer.TreeNode right_left = new tree_divideConquer.TreeNode(3);
	 ...
	 * Traverse - Recursive
	 */
	static private tree_divideConquer.TreeNode preNode = null;

	public static boolean isValidBSTTraverseJun(tree_divideConquer.TreeNode root) {
		if (root == null) {
			return true;
		}
	...
	public boolean isValidBSTTraverseJiuzhang(tree_divideConquer.TreeNode root) {
		if (root == null) {
			return true;
		}
	...
	public boolean isValidBSTDivideConquer(tree_divideConquer.TreeNode root) {
	...
	private Result helper(tree_divideConquer.TreeNode root) {
		if (root == null) {
	 ...
	 * 
	 */
	public boolean isValidBSTNonRecursive1(tree_divideConquer.TreeNode root) {
		if (root == null) {
			return true;
		}
	 ...
	 * 
	 */
	public boolean isValidBSTNonRecursive2(tree_divideConquer.TreeNode root) {
		if (root == null) {
			return true;
		}
		if (root.left == null && root.right == null) {
		...
		Stack<tree_divideConquer.TreeNode> stack = new Stack<>();
		stack.push(root);
		tree_divideConquer.TreeNode pre = null;
		while (!stack.isEmpty()) {
			tree_divideConquer.TreeNode cur = stack.peek();
			if (cur.left != null) {
				stack.push(cur.left);
				cur.left = null;
			} else {
	...
	public boolean isValidBSTJunRecursive(tree_divideConquer.TreeNode root) {
		if (root == null) {
			return true;
		}
		if (root.left == null && root.right == null) {
	...
	public void inorderRecurisve(tree_divideConquer.TreeNode root) {
		if (root == null)
			return;
	...
	public static boolean isValidBST2(tree_divideConquer.TreeNode root) {
	...
	public static boolean isValidBST(tree_divideConquer.TreeNode p, double min, double max) {
		if (p == null)
			return true;
